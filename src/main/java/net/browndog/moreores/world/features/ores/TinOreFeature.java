...
public class TinOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("browndog_ores:tin_ore", FEATURE, new OreConfiguration(TinOreFeatureRuleTest.INSTANCE, BrowndogOresModBlocks.TIN_ORE.defaultBlockState(), 7));
		PLACED_FEATURE = PlacementUtils.register("browndog_ores:tin_ore", CONFIGURED_FEATURE,
	...
	private static class TinOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<TinOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("browndog_ores:tin_ore_match"), () -> codec);
