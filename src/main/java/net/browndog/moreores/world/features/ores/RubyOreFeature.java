...
public class RubyOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("browndog_ores:ruby_ore", FEATURE, new OreConfiguration(RubyOreFeatureRuleTest.INSTANCE, BrowndogOresModBlocks.RUBY_ORE.defaultBlockState(), 7));
		PLACED_FEATURE = PlacementUtils.register("browndog_ores:ruby_ore", CONFIGURED_FEATURE,
	...
	private static class RubyOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<RubyOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("browndog_ores:ruby_ore_match"), () -> codec);
