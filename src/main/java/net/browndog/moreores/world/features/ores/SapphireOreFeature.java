...
public class SapphireOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("browndog_ores:sapphire_ore", FEATURE, new OreConfiguration(SapphireOreFeatureRuleTest.INSTANCE, BrowndogOresModBlocks.SAPPHIRE_ORE.defaultBlockState(), 7));
		PLACED_FEATURE = PlacementUtils.register("browndog_ores:sapphire_ore", CONFIGURED_FEATURE,
	...
	private static class SapphireOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<SapphireOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("browndog_ores:sapphire_ore_match"), () -> codec);
