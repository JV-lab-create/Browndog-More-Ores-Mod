...
public class TopazOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("browndog_ores:topaz_ore", FEATURE, new OreConfiguration(TopazOreFeatureRuleTest.INSTANCE, BrowndogOresModBlocks.TOPAZ_ORE.defaultBlockState(), 7));
		PLACED_FEATURE = PlacementUtils.register("browndog_ores:topaz_ore", CONFIGURED_FEATURE,
	...
	private static class TopazOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<TopazOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("browndog_ores:topaz_ore_match"), () -> codec);
