...
public class TitaniumOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("browndog_ores:titanium_ore", FEATURE, new OreConfiguration(TitaniumOreFeatureRuleTest.INSTANCE, BrowndogOresModBlocks.TITANIUM_ORE.defaultBlockState(), 7));
		PLACED_FEATURE = PlacementUtils.register("browndog_ores:titanium_ore", CONFIGURED_FEATURE,
	...
	private static class TitaniumOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<TitaniumOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("browndog_ores:titanium_ore_match"), () -> codec);
